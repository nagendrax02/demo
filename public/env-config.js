const API_URL = {
  ...
  LEADMANAGEMENT: 'https://service.crm4b2c.com/v1/Marvin.svc/r[[REGION]]/[[ORGCODE]]',
  PLATFORM_V1: 'https://service.crm4b2c.com/v1/Marvin.svc/r[[REGION]]/[[ORGCODE]]',
...
const ENV_CONFIG = {
  ...
  LOCALIZATION_CDN_URL: 'https://localization.marvin.crm4b2c.com',
  API_URL,
  FORMS_API_URL,
  FORMS_RENDER_URL,
  ...
  //For External Apps
  API_URLS: {
    V1: 'https://api.crm4b2c.com/v1'
  },
  DISABLE_REGION_REDIRECTION: true,
  IS_DEV_ENV: true,
