...
describe('SocialMedia', () => {
  ...
  test('Should render SocialMedia component with custom icon when schemaName and link provided', async () => {
    //Arrange
    render(
      <SocialMedia
        link={link}
    ...
    //Assert
    await waitFor(() => expect(screen.getByTestId('facebook')).toBeInTheDocument());
  });
});
