...
describe('File', () => {
  ...
  test('Should not render any content when file value not exist', () => {
    //Arrange
    render(
      <div data-testid="not-uploaded-file">
        <File
          property={{
            id: '1',
            name: 'File',
    ...
    //Assert
    expect(screen.getByTestId('not-uploaded-file')).toHaveTextContent('');
  });
