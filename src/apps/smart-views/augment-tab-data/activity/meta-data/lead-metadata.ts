...
import { ConditionEntityType, DISPLAY_NAME, GROUPS } from '../../../constants/constants';
...
const fetchLeadMetadataForActivity = async (
  tabId: string
): Promise<{
  ...
  const representationName =
    (await fetchRepresentationName(CallerSource.SmartViews, leadType)) ??
...
export { fetchLeadMetadataForActivity };
