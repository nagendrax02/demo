...
describe('Tab Utils', () => {
  ...
  describe('getTabIconElement', () => {
    ...
    it('Should return the tab icon element for secondary tabs', () => {
      // Arrange
      const config = { ...mockConfig, type: TabType.Secondary };
    ...
    it('Should return null for non-secondary tabs', () => {
      const config = { ...mockConfig, type: TabType.Primary };
  ...
  describe('getCloseTabButton', () => {
    ...
    it('Should return the close tab button for secondary tabs', () => {
      // Arrange
      const config = { ...mockConfig, type: TabType.Secondary };
      const appTabsConfig = [];

      // Act
      const result = getCloseTabButton(config, appTabsConfig, mockUpdateUrl);
